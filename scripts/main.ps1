...
. C:\Skripte\share.ps1 # set-share ()
. C:\Skripte\user.ps1 # new-user ()
. C:\Skripte\pc.ps1 # new-pc ()
. C:\Skripte\ou.ps1 # new-ou () # verschachtel-ou ()
. C:\Skripte\group.ps1 # new-group ()
. C:\Skripte\transport.ps1 # transport-user-in-ou () # transport-pc-in-ou () # transport-user-in-group ()
